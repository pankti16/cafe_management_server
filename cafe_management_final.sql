...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Aug 16, 2023 at 08:35 AM
...
-- Functions
--
CREATE DEFINER=`cafe_root_user`@`%` FUNCTION `GenerateEmployeeIdentifier` () RETURNS VARCHAR(10) CHARSET utf8mb4  BEGIN
    DECLARE unique_identifier VARCHAR(10);
    SET unique_identifier = CONCAT('UI', LPAD(CONV(FLOOR(RAND() * 16777215), 10, 36), 6, '0'));
...
('0a3a2740-3851-11ee-be75-448a5b2c2d83', 'OTC Cafe', 'OTC is a café & bar well tucked away from hectic city life. The cozy atmosphere makes it one of the best meeting places in Bugis for an intimate catch-up, a quick lunch meeting, or an enjoyable dinner before catching a performance.', 'df6cbd2d-f0d4-46e2-9735-2cd871cd6fb6-test_cafe.jpg', 'Singapore', 1),
('0a3a3635-3851-11ee-be75-448a5b2c2d83', 'MiMi.c Cafee', 'A wonderful place for coffee and dessert.', NULL, 'Singapore', 1);
...
(5, '0a3a3635-3851-11ee-be75-448a5b2c2d83', 'UI0179QS', '2023-08-13 15:28:21', 1);
...
('UI0179QS', 'Test', 'john@doe.com', 88765434, 'male', 1);
